                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            >
                                                {isVisible ? (
                                                    <svg height="24" width="24" fill="none" className="size-5 stroke-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <CardFooter className="grid space-y-4">
                {
                    [{
                        title: "Google",
                        icon: (
                            <svg width="24" height="24" viewBox="0 0 24 24" className="size-6 fill-current" fill="none" xmlns="http://www.w3.org/2000/svg">

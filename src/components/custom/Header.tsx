...
export default function Header(
    ...
    return (
        <div>
            ...
            </BoxReveal><BoxReveal boxColor={"#2D2D2D"} duration={0.6}>
            <p className="text-xl xl:text-3xl font-semibold py-3 pb-6">
                {description}
            </p>
        </BoxReveal><BoxReveal boxColor={"#2D2D2D"} duration={0.7}>

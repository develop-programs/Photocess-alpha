            ...
            <div className='h-screen' style={{
                ...
                <div className='h-full max-w-[90rem] container relative flex items-start justify-center flex-col gap-12'>
                    <div className='w-full grid gap-4 md:pe-32 xl:pe-[32rem]'>
                        <h1 className='text-5xl md:text-6xl xl:text-[5.3125rem] font-black leading-tight'>Background
                            <br /> Remover</h1>
                        <p className='text-xl xl:text-3xl font-semibold'>Remove background of any image effortlessly</p>
                        <span className='text-base xl:text-xl'>Easily remove backgrounds from your photos! Simplify your images and create beautiful visuals with just a few clicks.</span>
                    </div>
                </div>
                <div className='-mt-40 w-full grid place-content-center'>
                    <div className='bg-[#161616] w-[25rem] md:w-[40rem] lg:w-[50rem] xl:w-[70rem] flex items-center justify-center flex-col gap-6 rounded-xl border border-slate-300 py-12 xl:py-16'>
                        <svg width="73" height="72" className='size-12 lg:size-24' viewBox="0 0 73 72" fill="none" xmlns="http://www.w3.org/2000/svg" stroke='currentColor'>
                        ...
                        <span className='text-sm lg:text-xl'>Drag &apos;n&apos; drop files here, or click to selet files</span>
                    ...
                    [
                        {
                            svg: (
                                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                                    <path d="M9.28881 25.6318L23.278 3.64879C23.5465 3.22677 24.1998 3.417 24.1998 3.91722V19.7002C24.1998 19.7554 24.2446 19.8002 24.2998 19.8002H34.2395C34.644 19.8002 34.8811 20.2555 34.6491 20.5869L20.7094 40.5007C20.4291 40.9012 19.7998 40.7029 19.7998 40.214V26.5002C19.7998 26.445 19.755 26.4002 19.6998 26.4002H9.71064C9.3161 26.4002 9.07699 25.9646 9.28881 25.6318Z" stroke="white" strokeWidth="2" />
                                </svg>
                            ),
                            title: "Lighting Fast",
                            ...
                            svg: (
                                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                                    <path d="M38.5 22C38.5 31.1127 31.1127 38.5 22 38.5C12.8873 38.5 5.5 31.1127 5.5 22C5.5 12.8873 12.8873 5.5 22 5.5C24.5888 5.5 27.0383 6.09618 29.2188 7.15873M35.4062 11.6875L20.9688 26.125L16.8438 22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            ),
                            title: "Easy to use",
                        ...
                        <div key={index} className='grid gap-2 pe-4 xl:pe-12 place-content-start bg-[#2D2D2D] p-4 xl:p-6
                        rounded-lg'>
                            {item.svg}
                    ...
                    <div className='space-y-6'>
                        {[
                            ...
                            <div key={index} className='flex items-start gap-3'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" className='size-6' viewBox="0 0 32 32" fill="none">
                                    <path d="M11.9339 27.5295C8.23067 26.6608 5.33916 23.7693 4.4705 20.0661C3.84316 17.3917 3.84316 14.6083 4.4705 11.9339C5.33916 8.23068 8.23067 5.33916 11.9339 4.4705C14.6083 3.84317 17.3917 3.84317 20.0661 4.4705C23.7693 5.33916 26.6608 8.23067 27.5295 11.9339C28.1568 14.6083 28.1568 17.3917 27.5295 20.0661C26.6608 23.7693 23.7693 26.6608 20.0661 27.5295C17.3917 28.1568 14.6083 28.1568 11.9339 27.5295Z" stroke="#0095FF" strokeWidth="1.5" />
                                    <path d="M11.9339 27.5295C14.6083 28.1568 17.3917 28.1568 20.0661 27.5295C23.7693 26.6608 26.6608 23.7693 27.5295 20.0661C28.1568 17.3917 28.1568 14.6083 27.5295 11.9339C26.6608 8.23067 23.7693 5.33916 20.0661 4.4705C17.3917 3.84317 14.6083 3.84317 11.9339 4.4705C8.23067 5.33916 5.33916 8.23068 4.4705 11.9339" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                                    <path d="M12.333 15.6668L14.9997 18.3335L19.6663 13.3335" stroke="#0095FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>

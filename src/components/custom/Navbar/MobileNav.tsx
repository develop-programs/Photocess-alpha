...
export default function MobileNav() {
    return (
        <div
            className='absolute inset-0 w-full h-24 max-w-7xl container flex justify-between items-center py-2 px-4 z-50'>
            ...
            <Sheet>
                <SheetTrigger asChild>
                    <Button variant="ghost" size="icon" className='p-0'>
                        <svg height="44" width="44" fill="none" className='size-24' viewBox="0 0 44 44"

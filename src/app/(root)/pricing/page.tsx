            ...
            <section className="container mx-auto px-4 py-16">
                ...
                <Accordion type="single" collapsible className="max-w-2xl mx-auto">
                    ...
                    <AccordionItem value="item-2">
                        ...
                        <AccordionContent className="text-zinc-400">
                            You can upgrade to our premium plan for unlimited access or purchase additional credits.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Blog</Link></li>
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Careers</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="font-bold mb-4">Support</h3>
                            <ul className="space-y-2">
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Help Center</Link></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Community</Link></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Terms</Link></li>
                                <li><Link href="#" className="text-zinc-400 hover:text-white">License</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="font-bold mb-4">Social</h3>
                            <ul className="space-y-2">
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Twitter</Link></li>
                                <li><Link href="#" className="text-zinc-400 hover:text-white">GitHub</Link></li>
                                <li><Link href="#" className="text-zinc-400 hover:text-white">Discord</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>

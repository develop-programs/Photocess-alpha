            ...
            <div className="max-w-6xl mx-auto">
                <div className="py-12 mt-24 grid md:grid-cols-3 gap-3">
                    {[
                        ...
                        {
                            svg: (
                                <svg height="44" width="44" fill="none" viewBox="0 0 44 44"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div
                            key={index}
                            className={`grid gap-2 pe-4 xl:pe-12 place-content-start bg-gray-900 p-4 xl:p-6 rounded-lg transition-transform duration-500 ${index === 0
                ...
                <div className="py-12 grid place-content-center text-center gap-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 items-center">
                        {[
                            ...
                            {
                                svg: (
                                    <svg width="32" height="32" viewBox="0 0 32 32" className="size-5" fill="none" xmlns="http://www.w3.org/2000/svg">

                                            ...
                                            >
                                                {isVisible ? (
                                                    <svg height="24" width="24" fill="none"
                                                         className="size-5 stroke-current" viewBox="0 0 24 24"
                                                        ...
                                                        <path d="M15.51 12.7C15.25 14.11 14.1 15.26 12.69 15.52"
                                                              strokeLinecap="round" strokeLinejoin="round"
                                                              strokeWidth="1.5"/>
                                                        <path d="M9.47 14.53L2 22" strokeLinecap="round"
                                                              strokeLinejoin="round" strokeWidth="1.5"/>
                                                        <path d="M22 2L14.53 9.47" strokeLinecap="round"
                                                              strokeLinejoin="round" strokeWidth="1.5"/>
                                                    </svg>
                                                ) : (
                                                    <svg height="24" width="24" fill="none"
                        ...
                        <div className="w-full flex items-center justify-end">
                            <Dialog>
                                <DialogTrigger asChild>
                                    <Button variant="linkHover2" className="text-sm">Forget Password ?</Button>
                                </DialogTrigger>
                                <DialogContent>
                                    <DialogTitle>Reset Password</DialogTitle>
                                    <DialogDescription>
                                        Please enter your email address to receive a code to reset your password.
                                    </DialogDescription>
                                    <div className="flex flex-col justify-end">
                                        <div className="flex rounded-lg shadow-sm shadow-black/5">
                                            ...
                                            <div className="relative inline-flex">
                                                ...
                                                <span
                                                    className="pointer-events-none absolute inset-y-0 end-0 z-10 flex h-full w-9 items-center justify-center text-muted-foreground/80 peer-disabled:opacity-50"><svg
...
<path fillRule="evenodd" clipRule="evenodd"
      ...
      fill="currentColor"/>
                                        ...
                                        <Button variant="outline" className="mt-2">Send Code</Button>
                                    </div>
                                </DialogContent>
                            </Dialog>
                        </div>
            ...
            <CardFooter className="grid grid-cols-2 gap-2">
                {
                    [{
                        title: "Google",
                        icon: (
                            <svg width="24" height="24" viewBox="0 0 24 24" className="size-4 fill-current" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        func: () => signIn("google", {callbackUrl: `${typeof window != undefined ? window.location.origin : "/"}`})
                    },
                        {
                            title: "Github",
                            icon: (<svg width="48" height="48" viewBox="0 0 48 48" className="size-4 stroke-current"
                            ...
                            func: () => signIn("github", {callbackUrl: `${typeof window != undefined ? window.location.origin : "/"}`})
                        }].map((item, index) => (
                        <Button key={index} variant="outline" onClick={item.func} className="gap-2">
                            {item.icon}
                            {item.title}
                        </Button>
                    ))
                ...
                <div className="col-span-2 mt-2 flex gap-2 justify-center items-center">
                    ...
                    <Link href="/api/auth/signUp"
                          className="text-sm hover:underline hover:underline-offset-2">SignUp</Link>
                </div>
            </CardFooter>
        </Card>
    )

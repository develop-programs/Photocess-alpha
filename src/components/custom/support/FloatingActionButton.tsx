        ...
        <section typeof="action button" aria-label="support button">
            <Popover>
                <PopoverTrigger asChild={true}>
                    <Button className="fixed bottom-12 right-12 rounded-full p-0 size-12" aria-label='support_button'>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" className='size-80' viewBox="0 0 128 128" fill='currentColor'>
                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="p-2 flex border-b items-center">
                            ...
                            <PopoverClose asChild={true} className="ml-auto">
                                <svg width="24" height="24" viewBox="0 0 24 24" className='size-7' fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            ...
                            <div className="flex items-center justify-end gap-2">
                                <div className="bg-slate-500 text-white rounded-lg p-2 max-w-[80%]">
